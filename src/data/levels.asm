...
SailorHub0ExitTable: ; 8c354 (23:4354)
	...
	exit 0, 16, 0, 17, 0, CAGE, 0, 240, 208, LEFT
	exit 31, 18, 31, 19, 0, CROW, 0, 8, 152, RIGHT
	exit 7, 0, 8, 0, 0, ITEMS, 0, 128, 240, UP
	exit 24, 0, 25, 0, 0, BOSS, 0, 64, 108, UP
	exit 16, 7, 17, 7, 1, 3, 136, 64
	end_exits
SailorCage0ExitTable: ; 8c3b5 (23:43b5)
	...
	exit 31, 25, 31, 26, 0, HUB, 0, 8, 136, RIGHT
	exit 3, 0, 4, 0, 0, CAGE, 2, 40, 240, UP
	exit 31, 4, 31, 5, 0, CAGE, 5, 16, 208, RIGHT
	exit 4, 27, 4, 27, 2, CAGE, 3, 76, 40, DOWN
	exit 0, 27, 0, 28, 0, CAGE, 6, 240, 176, LEFT
	end_exits
SailorCage1ExitTable: ; 8c410 (23:4410)
	...
	exit 0, 5, 0, 6, 0, CAGE, 5, 240, 56, LEFT
	exit 0, 21, 0, 22, 0, CAGE, 5, 240, 208, LEFT
	exit 23, 4, 23, 4, 3, CAGE, 4, 128, 208, UP
	end_exits
SailorCage2ExitTable: ; 8c443 (23:4443)
	...
	exit 4, 31, 5, 31, 0, CAGE, 0, 32, 8, DOWN
	exit 31, 24, 31, 25, 0, CAGE, 5, 8, 56, RIGHT
	end_exits
SailorCage3ExitTable: ; 8c46c (23:446c)
	db 1
	dw SailorCage3Exit_0
	begin_exits "SailorCage3"
	exit 4, 12, 4, 12, 2, CAGE, 0, 36, 224, DOWN
	end_exits
...
SailorCage5ExitTable: ; 8c478 (23:4478)
	...
	exit 0, 25, 0, 26, 0, CAGE, 0, 240, 40, LEFT
	exit 31, 6, 31, 7, 0, CAGE, 1, 8, 48, RIGHT
	exit 31, 25, 31, 26, 0, CAGE, 1, 16, 176, RIGHT
	exit 18, 0, 19, 0, 0, CAGE, 8, 176, 240, UP
	exit 0, 6, 0, 7, 0, CAGE, 2, 240, 200, LEFT
	end_exits
SailorCage6ExitTable: ; 8c4dd (23:44dd)
	...
	exit 31, 21, 31, 22, 0, CAGE, 0, 16, 224, RIGHT
	exit 16, 0, 17, 0, 0, CAGE, 7, 120, 240, UP
	end_exits
SailorCage7ExitTable: ; 8c506 (23:4506)
	...
	exit 14, 31, 15, 31, 0, CAGE, 6, 136, 8, DOWN
	exit 31, 4, 31, 5, 0, CAGE, 8, 8, 80, RIGHT
	end_exits
SailorCage8ExitTable: ; 8c52f (23:452f)
	...
	exit 0, 9, 0, 10, 0, CAGE, 7, 240, 40, LEFT
	exit 13, 0, 14, 0, 0, CAGE, 9, 120, 240, UP
	exit 21, 31, 22, 31, 0, CAGE, 5, 152, 8, DOWN
	end_exits
SailorCage9ExitTable: ; 8c56c (23:456c)
	db 2
	dw SailorCage9Exit_0
	begin_exits "SailorCage9"
	exit 14, 31, 15, 31, 0, CAGE, 8, 112, 8, DOWN
	end_exits
SailorCrow0ExitTable: ; 8c581 (23:4581)
	...
	exit 0, 18, 0, 19, 0, HUB, 0, 240, 152, LEFT
	exit 31, 5, 31, 6, 0, CROW, 1, 8, 48, RIGHT
	end_exits
SailorCrow1ExitTable: ; 8c5aa (23:45aa)
	...
	exit 0, 5, 0, 6, 0, CROW, 0, 240, 48, LEFT
	exit 31, 12, 31, 13, 0, CROW, 2, 8, 104, RIGHT
	exit 31, 19, 31, 20, 0, CROW, 2, 8, 160, RIGHT
	end_exits
SailorCrow2ExitTable: ; 8c5e7 (23:45e7)
	...
	exit 0, 12, 0, 13, 0, CROW, 1, 240, 104, LEFT
	exit 0, 19, 0, 20, 0, CROW, 1, 240, 160, LEFT
	exit 22, 0, 23, 0, 0, CROW, 4, 64, 240, UP
	exit 31, 18, 31, 19, 0, CROW, 3, 8, 112, RIGHT
	exit 27, 10, 27, 10, 3, CROW, 6, 200, 208, UP
	exit 12, 0, 13, 0, 0, CROW, 7, 104, 240, UP
	end_exits
SailorCrow3ExitTable: ; 8c656 (23:4656)
	...
	exit 0, 13, 0, 14, 0, CROW, 2, 240, 152, LEFT
	exit 5, 0, 6, 0, 0, CROW, 4, 208, 240, UP
	exit 23, 15, 23, 15, 2, CROW, 5, 72, 40, DOWN
	end_exits
SailorCrow4ExitTable: ; 8c689 (23:4689)
	...
	exit 7, 31, 8, 31, 0, CROW, 2, 184, 8, DOWN
	exit 25, 31, 26, 31, 0, CROW, 3, 48, 8, DOWN
	end_exits
SailorCrow5ExitTable: ; 8c6b2 (23:46b2)
	db 1
	dw SailorCrow5Exit_0
	begin_exits "SailorCrow5"
	exit 4, 10, 4, 10, 2, CROW, 3, 184, 128, DOWN
	end_exits
...
SailorCrow7ExitTable: ; 8c6be (23:46be)
	...
	exit 12, 31, 13, 31, 0, CROW, 2, 104, 8, DOWN
	exit 31, 10, 31, 11, 0, CROW, 8, 8, 88, RIGHT
	exit 0, 11, 0, 12, 0, CROW, 9, 240, 96, LEFT
	exit 12, 0, 13, 0, 0, CROW, 10, 104, 240, UP
	end_exits
SailorCrow8ExitTable: ; 8c70f (23:470f)
	...
	exit 0, 10, 0, 11, 0, CROW, 7, 240, 88, LEFT
	exit 31, 10, 31, 11, 0, CROW, 9, 8, 96, RIGHT
	end_exits
SailorCrow9ExitTable: ; 8c738 (23:4738)
	...
	exit 0, 11, 0, 12, 0, CROW, 8, 240, 88, LEFT
	exit 31, 11, 31, 12, 0, CROW, 7, 8, 96, RIGHT
	end_exits
SailorCrow10ExitTable: ; 8c761 (23:4761)
	...
	exit 24, 23, 25, 23, 0, CROW, 10, 56, 40, DOWN
	exit 15, 23, 16, 23, 0, CROW, 10, 200, 40, DOWN
	exit 6, 23, 7, 23, 0, CROW, 10, 128, 40, DOWN
	exit 15, 4, 16, 4, 0, CROW, 10, 200, 192, DOWN
	exit 24, 4, 25, 4, 0, CROW, 10, 56, 192, DOWN
	exit 6, 4, 7, 4, 0, CROW, 10, 128, 192, DOWN
	exit 12, 31, 13, 31, 0, CROW, 7, 104, 8, DOWN
	end_exits
SailorItems0ExitTable: ; 8c7ee (23:47ee)
	...
	exit 15, 31, 16, 31, 0, HUB, 0, 64, 8, DOWN
	exit 5, 0, 6, 0, 0, ITEMS, 8, 48, 240, UP
	exit 24, 0, 25, 0, 0, ITEMS, 8, 200, 240, UP
	exit 14, 6, 14, 6, 2, ITEMS, 6, 88, 88, DOWN
	end_exits
SailorItems1ExitTable: ; 8c835 (23:4835)
	...
	exit 22, 0, 23, 0, 0, ITEMS, 4, 112, 240, UP
	exit 31, 6, 31, 7, 0, ITEMS, 10, 8, 40, RIGHT
	exit 31, 17, 31, 18, 0, ITEMS, 10, 8, 216, RIGHT
	exit 24, 31, 25, 31, 0, ITEMS, 8, 200, 8, DOWN
	exit 5, 31, 6, 31, 0, ITEMS, 8, 48, 8, DOWN
	exit 0, 15, 0, 16, 0, ITEMS, 9, 240, 200, LEFT
	end_exits
SailorItems2ExitTable: ; 8c8ae (23:48ae)
	...
	exit 17, 0, 18, 0, 0, ITEMS, 5, 56, 232, UP
	exit 31, 18, 31, 19, 0, ITEMS, 9, 8, 40, RIGHT
	exit 9, 18, 9, 18, 3, ITEMS, 7, 128, 208, UP
	end_exits
SailorItems3ExitTable: ; 8c8e1 (23:48e1)
	...
	exit 0, 6, 0, 7, 0, ITEMS, 10, 240, 40, LEFT
	exit 0, 17, 0, 18, 0, ITEMS, 10, 240, 216, LEFT
	end_exits
SailorItems4ExitTable: ; 8c90a (23:490a)
	...
	exit 0, 6, 0, 7, 0, ITEMS, 5, 240, 56, LEFT
	exit 0, 15, 0, 16, 0, ITEMS, 5, 240, 128, LEFT
	exit 13, 31, 14, 31, 0, ITEMS, 1, 184, 8, UP
	end_exits
SailorItems5ExitTable: ; 8c947 (23:4947)
	...
	exit 31, 6, 31, 7, 0, ITEMS, 4, 8, 56, RIGHT
	exit 31, 15, 31, 16, 0, ITEMS, 4, 8, 128, RIGHT
	exit 6, 30, 7, 30, 0, ITEMS, 2, 144, 8, DOWN
	end_exits
SailorItems6ExitTable: ; 8c984 (23:4984)
	db 1
	dw SailorItems6Exit_0
	begin_exits "SailorItems6"
	exit 10, 7, 10, 7, 2, ITEMS, 0, 112, 56, DOWN
	end_exits
...
SailorItems8ExitTable: ; 8c990 (23:4990)
	...
	exit 24, 31, 25, 31, 0, ITEMS, 0, 200, 8, DOWN
	exit 5, 31, 6, 31, 0, ITEMS, 0, 48, 8, DOWN
	exit 24, 0, 25, 0, 0, ITEMS, 1, 200, 240, UP
	exit 5, 0, 6, 0, 0, ITEMS, 1, 48, 240, UP
	end_exits
SailorItems9ExitTable: ; 8c9e1 (23:49e1)
	...
	exit 31, 24, 31, 25, 0, ITEMS, 1, 8, 128, RIGHT
	exit 23, 0, 24, 0, 0, ITEMS, 11, 200, 240, UP
	exit 0, 4, 0, 5, 0, ITEMS, 2, 240, 152, LEFT
	end_exits
SailorItems10ExitTable: ; 8ca1e (23:4a1e)
	...
	exit 0, 4, 0, 5, 0, ITEMS, 1, 240, 56, LEFT
	exit 0, 26, 0, 27, 0, ITEMS, 1, 240, 144, LEFT
	exit 31, 4, 31, 5, 0, ITEMS, 3, 8, 56, RIGHT
	exit 31, 26, 31, 27, 0, ITEMS, 3, 8, 144, RIGHT
	end_exits
SailorItems11ExitTable: ; 8ca6f (23:4a6f)
	...
	exit 24, 31, 25, 31, 0, ITEMS, 9, 192, 8, DOWN
	exit 13, 0, 14, 0, 0, ITEMS, 12, 64, 240, UP
	end_exits
SailorItems12ExitTable: ; 8ca98 (23:4a98)
	db 2
	dw SailorItems12Exit_0
	begin_exits "SailorItems12"
	exit 7, 31, 8, 31, 0, ITEMS, 11, 112, 8, DOWN
	end_exits
...
CossackHub0ExitTable: ; 8caae (23:4aae)
	...
	exit 11, 0, 12, 0, 0, HERB, 0, 128, 240, UP
	exit 6, 5, 7, 5, 0, MINES, 0, 152, 240, UP
	exit 31, 19, 31, 20, 0, SNOWMAN, 0, 8, 208, RIGHT
	exit 27, 3, 28, 3, 0, BOSS, 0, 64, 96, UP
	exit 13, 15, 14, 15, 1, 3, 112, 128
	end_exits
CossackHerb0ExitTable: ; 8cb0f (23:4b0f)
	...
	exit 15, 31, 16, 31, 0, HUB, 0, 96, 8, DOWN
	exit 27, 0, 28, 0, 0, HERB, 7, 128, 240, UP
	end_exits
CossackHerb1ExitTable: ; 8cb38 (23:4b38)
	...
	exit 2, 0, 3, 0, 0, HERB, 2, 24, 240, UP
	exit 28, 31, 29, 31, 0, HERB, 7, 128, 8, DOWN
	exit 0, 21, 0, 22, 0, HERB, 3, 240, 208, LEFT
	exit 2, 17, 2, 17, 2, HERB, 5, 96, 40, DOWN
	end_exits
CossackHerb2ExitTable: ; 8cb7f (23:4b7f)
	...
	exit 2, 31, 3, 31, 0, HERB, 1, 24, 8, DOWN
	exit 26, 16, 26, 16, 3, HERB, 6, 128, 200, UP
	end_exits
CossackHerb3ExitTable: ; 8cb9e (23:4b9e)
	...
	exit 14, 0, 15, 0, 0, HERB, 4, 120, 240, UP
	exit 31, 25, 31, 26, 0, HERB, 1, 8, 176, RIGHT
	end_exits
CossackHerb4ExitTable: ; 8cbc7 (23:4bc7)
	...
	exit 14, 31, 15, 31, 0, HERB, 3, 120, 8, DOWN
	exit 6, 0, 7, 0, 0, HERB, 8, 120, 240, UP
	end_exits
CossackHerb5ExitTable: ; 8cbf0 (23:4bf0)
	db 1
	dw CossackHerb5Exit_0
	begin_exits "CossackHerb5"
	exit 3, 12, 3, 12, 2, HERB, 1, 24, 152, DOWN
	end_exits
...
CossackHerb7ExitTable: ; 8cbfc (23:4bfc)
	...
	exit 15, 31, 16, 31, 0, HERB, 0, 224, 8, DOWN
	exit 15, 0, 16, 0, 0, HERB, 1, 232, 240, UP
	end_exits
CossackHerb8ExitTable: ; 8cc25 (23:4c25)
	...
	exit 14, 31, 15, 31, 0, HERB, 4, 56, 8, UP
	exit 12, 0, 13, 0, 0, HERB, 9, 120, 240, UP
	end_exits
CossackHerb9ExitTable: ; 8cc4e (23:4c4e)
	db 2
	dw CossackHerb9Exit_0
	begin_exits "CossackHerb9"
	exit 14, 31, 15, 31, 0, HERB, 8, 104, 8, DOWN
	end_exits
CossackMines0ExitTable: ; 8cc63 (23:4c63)
	...
	exit 18, 31, 19, 31, 0, HUB, 0, 56, 49, DOWN
	exit 15, 0, 16, 0, 0, MINES, 8, 72, 240, UP
	end_exits
CossackMines1ExitTable: ; 8cc8c (23:4c8c)
	...
	exit 15, 31, 16, 31, 0, MINES, 8, 176, 8, DOWN
	exit 24, 0, 25, 0, 0, MINES, 2, 208, 240, UP
	exit 31, 6, 31, 7, 0, MINES, 4, 8, 208, RIGHT
	exit 29, 16, 29, 16, 3, MINES, 7, 128, 208, UP
	end_exits
CossackMines2ExitTable: ; 8ccd3 (23:4cd3)
	...
	exit 25, 31, 26, 31, 0, MINES, 1, 200, 8, DOWN
	exit 31, 23, 31, 24, 0, MINES, 4, 8, 96, RIGHT
	exit 6, 0, 7, 0, 0, MINES, 9, 104, 240, UP
	end_exits
CossackMines3ExitTable: ; 8cd10 (23:4d10)
	db 2
	dw CossackMines3Exit_0
	begin_exits "CossackMines3"
	exit 0, 27, 0, 28, 0, MINES, 4, 240, 224, LEFT
	end_exits
CossackMines4ExitTable: ; 8cd25 (23:4d25)
	...
	exit 31, 27, 31, 28, 0, MINES, 3, 8, 224, RIGHT
	exit 18, 0, 19, 0, 0, MINES, 5, 152, 240, UP
	exit 0, 11, 0, 12, 0, MINES, 2, 240, 192, LEFT
	exit 0, 25, 0, 26, 0, MINES, 1, 240, 56, LEFT
	exit 11, 25, 11, 25, 2, MINES, 6, 32, 88, UP
	end_exits
CossackMines5ExitTable: ; 8cd80 (23:4d80)
	db 2
	dw CossackMines5Exit_0
	begin_exits "CossackMines5"
	exit 18, 31, 19, 31, 0, MINES, 4, 152, 8, DOWN
	end_exits
CossackMines6ExitTable: ; 8cd95 (23:4d95)
	db 1
	dw CossackMines6Exit_0
	begin_exits "CossackMines6"
	exit 9, 4, 9, 4, 2, MINES, 4, 88, 208, UP
	end_exits
...
CossackMines8ExitTable: ; 8cda1 (23:4da1)
	...
	exit 8, 31, 9, 31, 0, MINES, 0, 128, 8, DOWN
	exit 21, 0, 22, 0, 0, MINES, 1, 128, 232, UP
	end_exits
CossackMines9ExitTable: ; 8cdca (23:4dca)
	...
	exit 12, 31, 13, 31, 0, MINES, 2, 56, 8, DOWN
	exit 24, 0, 25, 0, 0, MINES, 10, 216, 232, UP
	exit 5, 0, 6, 0, 0, MINES, 10, 40, 232, UP
	end_exits
CossackMines10ExitTable: ; 8ce07 (23:4e07)
	...
	exit 26, 30, 27, 30, 0, MINES, 9, 200, 8, DOWN
	exit 4, 30, 5, 30, 0, MINES, 9, 48, 8, DOWN
	end_exits
CossackSnowman0ExitTable: ; 8ce30 (23:4e30)
	...
	exit 0, 25, 0, 26, 0, HUB, 0, 240, 160, LEFT
	exit 13, 0, 14, 0, 0, SNOWMAN, 12, 112, 240, UP
	exit 29, 7, 29, 7, 2, SNOWMAN, 6, 24, 48, RIGHT
	end_exits
CossackSnowman1ExitTable: ; 8ce63 (23:4e63)
	...
	exit 13, 31, 14, 31, 0, SNOWMAN, 12, 112, 8, DOWN
	exit 20, 0, 21, 0, 0, SNOWMAN, 2, 64, 112, UP
	end_exits
CossackSnowman2ExitTable: ; 8ce8c (23:4e8c)
	...
	exit 7, 15, 8, 15, 0, SNOWMAN, 1, 168, 8, DOWN
	exit 6, 0, 7, 0, 0, SNOWMAN, 2, 64, 112, UP
	exit 0, 7, 0, 8, 0, SNOWMAN, 8, 112, 64, LEFT
	exit 15, 7, 15, 8, 0, SNOWMAN, 2, 8, 64, RIGHT
	end_exits
CossackSnowman3ExitTable: ; 8cedd (23:4edd)
	...
	exit 14, 0, 15, 0, 0, SNOWMAN, 2, 64, 112, DOWN
	exit 11, 31, 12, 31, 0, SNOWMAN, 4, 96, 8, DOWN
	exit 22, 31, 23, 31, 0, SNOWMAN, 4, 184, 8, DOWN
	end_exits
CossackSnowman4ExitTable: ; 8cf1a (23:4f1a)
	...
	exit 11, 0, 12, 0, 0, SNOWMAN, 3, 96, 240, UP
	exit 22, 0, 23, 0, 0, SNOWMAN, 3, 184, 240, UP
	exit 6, 31, 7, 31, 0, SNOWMAN, 5, 56, 8, DOWN
	end_exits
CossackSnowman5ExitTable: ; 8cf57 (23:4f57)
	...
	exit 6, 0, 7, 0, 0, SNOWMAN, 4, 56, 240, UP
	exit 3, 21, 3, 21, 3, SNOWMAN, 7, 128, 200, UP
	end_exits
CossackSnowman6ExitTable: ; 8cf76 (23:4f76)
	db 1
	dw CossackSnowman6Exit_0
	begin_exits "CossackSnowman6"
	exit 13, 9, 13, 9, 2, SNOWMAN, 0, 232, 64, DOWN
	end_exits
...
CossackSnowman8ExitTable: ; 8cf82 (23:4f82)
	...
	exit 7, 15, 8, 15, 0, SNOWMAN, 2, 56, 8, DOWN
	exit 6, 0, 7, 0, 0, SNOWMAN, 9, 64, 112, UP
	exit 0, 7, 0, 8, 0, SNOWMAN, 2, 112, 64, LEFT
	exit 15, 7, 15, 8, 0, SNOWMAN, 2, 8, 64, RIGHT
	end_exits
CossackSnowman9ExitTable: ; 8cfd3 (23:4fd3)
	...
	exit 7, 15, 8, 15, 0, SNOWMAN, 8, 56, 8, DOWN
	exit 6, 0, 7, 0, 0, SNOWMAN, 10, 64, 112, UP
	exit 0, 7, 0, 8, 0, SNOWMAN, 2, 112, 64, LEFT
	exit 15, 7, 15, 8, 0, SNOWMAN, 2, 8, 64, RIGHT
	end_exits
CossackSnowman10ExitTable: ; 8d024 (23:5024)
	...
	exit 7, 15, 8, 15, 0, SNOWMAN, 9, 64, 8, DOWN
	exit 6, 0, 7, 0, 0, SNOWMAN, 2, 64, 112, UP
	exit 0, 7, 0, 8, 0, SNOWMAN, 2, 112, 64, LEFT
	exit 15, 7, 15, 8, 0, SNOWMAN, 11, 8, 64, RIGHT
	end_exits
CossackSnowman11ExitTable: ; 8d075 (23:5075)
	...
	exit 7, 15, 8, 15, 0, SNOWMAN, 3, 120, 8, DOWN
	exit 6, 0, 7, 0, 0, SNOWMAN, 2, 64, 112, UP
	exit 0, 7, 0, 8, 0, SNOWMAN, 2, 112, 64, LEFT
	exit 15, 7, 15, 8, 0, SNOWMAN, 2, 8, 64, RIGHT
	end_exits
CossackSnowman12ExitTable: ; 8d0c6 (23:50c6)
	...
	exit 13, 31, 14, 31, 0, SNOWMAN, 0, 112, 8, DOWN
	exit 13, 0, 14, 0, 0, SNOWMAN, 1, 112, 240, UP
	exit 4, 0, 5, 0, 0, SNOWMAN, 13, 40, 240, UP
	end_exits
CossackSnowman13ExitTable: ; 8d103 (23:5103)
	db 2
	dw CossackSnowman13Exit_0
	begin_exits "CossackSnowman13"
	exit 4, 31, 5, 31, 0, SNOWMAN, 12, 40, 8, DOWN
	end_exits
...
CavemanHub0ExitTable: ; 8d119 (23:5119)
	...
	exit 7, 4, 8, 4, 0, ROBO, 0, 152, 240, UP
	exit 25, 5, 26, 5, 0, GEARS, 0, 56, 240, UP
	exit 31, 22, 31, 23, 0, WATER, 0, 8, 208, RIGHT
	exit 17, 0, 18, 0, 0, BOSS, 0, 64, 64, UP
	exit 12, 22, 13, 22, 1, 3, 104, 184
	end_exits
CavemanRobo0ExitTable: ; 8d17a (23:517a)
	...
	exit 18, 31, 19, 31, 0, HUB, 0, 64, 41, DOWN
	exit 20, 0, 21, 0, 0, ROBO, 2, 72, 240, UP
	exit 7, 5, 7, 5, 2, ROBO, 6, 96, 72, RIGHT
	end_exits
CavemanRobo1ExitTable: ; 8d1c0 (23:51c0)
	...
	exit 31, 19, 31, 20, 0, ROBO, 2, 8, 72, RIGHT
	exit 28, 9, 28, 9, 3, ROBO, 7, 128, 208, UP
	exit 3, 0, 4, 0, 0, ROBO, 13, 224, 240, UP
	end_exits
CavemanRobo2ExitTable: ; 8d1f3 (23:51f3)
	...
	exit 8, 31, 9, 31, 0, ROBO, 0, 168, 8, DOWN
	exit 23, 0, 24, 0, 0, ROBO, 3, 208, 240, UP
	exit 0, 8, 0, 9, 0, ROBO, 1, 240, 160, LEFT
	end_exits
CavemanRobo3ExitTable: ; 8d230 (23:5230)
	...
	exit 25, 31, 26, 31, 0, ROBO, 2, 192, 8, DOWN
	exit 24, 0, 25, 0, 0, ROBO, 4, 64, 112, UP
	end_exits
CavemanRobo4ExitTable: ; 8d259 (23:5259)
	...
	exit 7, 15, 8, 15, 0, ROBO, 3, 200, 8, DOWN
	exit 7, 0, 8, 0, 0, ROBO, 4, 64, 112, UP
	exit 0, 6, 0, 7, 0, ROBO, 4, 112, 56, LEFT
	exit 15, 6, 15, 7, 0, ROBO, 8, 8, 56, RIGHT
	end_exits
CavemanRobo5ExitTable: ; 8d2aa (23:52aa)
	db 2
	dw CavemanRobo5Exit_0
	begin_exits "CavemanRobo5"
	exit 15, 31, 16, 31, 0, ROBO, 11, 64, 8, DOWN
	end_exits
CavemanRobo6ExitTable: ; 8d2bf (23:52bf)
	db 1
	dw CavemanRobo6Exit_0
	begin_exits "CavemanRobo6"
	exit 13, 12, 13, 12, 2, ROBO, 0, 60, 48, DOWN
	end_exits
...
CavemanRobo14ExitTable: ; 8d2cb (23:52cb)
	...
	exit 31, 3, 31, 4, 0, ROBO, 13, 8, 32, RIGHT
	end_exits
CavemanRobo8ExitTable: ; 8d2e0 (23:52e0)
	...
	exit 7, 15, 8, 15, 0, ROBO, 9, 64, 8, DOWN
	exit 7, 0, 8, 0, 0, ROBO, 4, 64, 112, UP
	exit 0, 6, 0, 7, 0, ROBO, 4, 112, 56, LEFT
	exit 15, 6, 15, 7, 0, ROBO, 4, 8, 56, RIGHT
	end_exits
CavemanRobo9ExitTable: ; 8d331 (23:5331)
	...
	exit 7, 15, 8, 15, 0, ROBO, 10, 64, 8, DOWN
	exit 7, 0, 8, 0, 0, ROBO, 4, 64, 112, UP
	exit 0, 6, 0, 7, 0, ROBO, 4, 112, 56, LEFT
	exit 15, 6, 15, 7, 0, ROBO, 4, 8, 56, RIGHT
	end_exits
CavemanRobo10ExitTable: ; 8d382 (23:5382)
	...
	exit 7, 15, 8, 15, 0, ROBO, 4, 64, 8, DOWN
	exit 7, 0, 8, 0, 0, ROBO, 4, 64, 112, UP
	exit 0, 6, 0, 7, 0, ROBO, 11, 112, 56, LEFT
	exit 15, 6, 15, 7, 0, ROBO, 4, 8, 56, RIGHT
	end_exits
CavemanRobo11ExitTable: ; 8d3d3 (23:53d3)
	...
	exit 7, 15, 8, 15, 0, ROBO, 4, 64, 8, DOWN
	exit 7, 0, 8, 0, 0, ROBO, 5, 128, 240, UP
	exit 0, 6, 0, 7, 0, ROBO, 4, 112, 56, LEFT
	exit 15, 6, 15, 7, 0, ROBO, 4, 8, 56, RIGHT
	end_exits
...
CavemanRobo13ExitTable: ; 8d475 (23:5475)
	...
	exit 27, 31, 28, 31, 0, ROBO, 1, 32, 8, DOWN
	exit 0, 3, 0, 4, 0, ROBO, 14, 240, 32, LEFT
	end_exits
CavemanGears0ExitTable: ; 8d49e (23:549e)
	...
	exit 6, 31, 7, 31, 0, HUB, 0, 208, 49, DOWN
	exit 0, 6, 0, 7, 0, GEARS, 4, 240, 208, LEFT
	exit 13, 0, 14, 0, 0, GEARS, 1, 64, 112, UP
	exit 31, 24, 31, 25, 0, GEARS, 2, 8, 112, RIGHT
	exit 28, 10, 28, 10, 3, GEARS, 7, 128, 208, UP
	end_exits
CavemanGears1ExitTable: ; 8d4f9 (23:54f9)
	...
	exit 7, 15, 8, 15, 0, GEARS, 0, 112, 16, DOWN
	exit 7, 0, 8, 0, 0, GEARS, 1, 64, 112, UP
	exit 0, 6, 0, 7, 0, GEARS, 1, 112, 56, LEFT
	exit 15, 6, 15, 7, 0, GEARS, 8, 8, 56, RIGHT
	end_exits
...
CavemanGears8ExitTable: ; 8d5dc (23:55dc)
	...
	exit 7, 15, 8, 15, 0, GEARS, 1, 64, 8, DOWN
	exit 7, 0, 8, 0, 0, GEARS, 1, 64, 112, UP
	exit 0, 6, 0, 7, 0, GEARS, 1, 112, 56, LEFT
	exit 15, 6, 15, 7, 0, GEARS, 9, 8, 56, RIGHT
	end_exits
CavemanGears9ExitTable: ; 8d62d (23:562d)
	...
	exit 7, 15, 8, 15, 0, GEARS, 1, 64, 8, DOWN
	exit 7, 0, 8, 0, 0, GEARS, 10, 64, 112, UP
	exit 0, 6, 0, 7, 0, GEARS, 1, 112, 56, LEFT
	exit 15, 6, 15, 7, 0, GEARS, 1, 8, 56, RIGHT
	end_exits
CavemanGears10ExitTable: ; 8d67e (23:567e)
	...
	exit 7, 0, 8, 0, 0, GEARS, 1, 64, 112, UP
	exit 0, 6, 0, 7, 0, GEARS, 1, 112, 56, LEFT
	exit 15, 6, 15, 7, 0, GEARS, 11, 8, 56, RIGHT
	end_exits
CavemanGears11ExitTable: ; 8d6cf (23:56cf)
	...
	exit 7, 15, 8, 15, 0, GEARS, 1, 64, 8, DOWN
	exit 7, 0, 8, 0, 0, GEARS, 5, 120, 232, UP
	exit 0, 6, 0, 7, 0, GEARS, 1, 112, 56, LEFT
	exit 15, 6, 15, 7, 0, GEARS, 1, 8, 56, RIGHT
	end_exits
CavemanGears12ExitTable: ; 8d720 (23:5720)
	...
	exit 26, 31, 27, 31, 0, GEARS, 2, 216, 8, DOWN
	exit 18, 0, 19, 0, 0, GEARS, 13, 144, 240, UP
	end_exits
CavemanGears13ExitTable: ; 8d749 (23:5749)
	db 2
	dw CavemanGears13Exit_0
	begin_exits "CavemanGears13"
	exit 17, 31, 18, 31, 0, GEARS, 12, 152, 8, DOWN
	end_exits
CavemanWater0ExitTable: ; 8d75e (23:575e)
	...
	exit 0, 25, 0, 26, 0, HUB, 0, 240, 184, LEFT
	exit 3, 0, 4, 0, 0, WATER, 1, 32, 240, UP
	exit 27, 0, 28, 0, 0, WATER, 1, 224, 240, UP
	end_exits
CavemanWater1ExitTable: ; 8d79b (23:579b)
	...
	exit 3, 31, 4, 31, 0, WATER, 0, 32, 8, DOWN
	exit 27, 31, 28, 31, 0, WATER, 0, 224, 8, DOWN
	exit 8, 0, 9, 0, 0, WATER, 3, 96, 240, UP
	exit 31, 7, 31, 8, 0, WATER, 2, 8, 64, RIGHT
	exit 24, 13, 24, 13, 3, WATER, 7, 56, 200, UP
	exit 13, 31, 14, 31, 0, WATER, 9, 192, 40, DOWN
	end_exits
CavemanWater2ExitTable: ; 8d80a (23:580a)
	...
	exit 0, 7, 0, 8, 0, WATER, 1, 240, 64, LEFT
	exit 11, 0, 12, 0, 0, WATER, 4, 96, 240, UP
	exit 27, 0, 28, 0, 0, WATER, 9, 72, 240, UP
	end_exits
CavemanWater3ExitTable: ; 8d847 (23:5847)
	...
	exit 11, 31, 12, 31, 0, WATER, 1, 72, 8, DOWN
	exit 31, 26, 31, 27, 0, WATER, 4, 8, 216, RIGHT
	exit 27, 11, 27, 11, 2, WATER, 6, 32, 40, DOWN
	exit 22, 0, 23, 0, 0, WATER, 11, 184, 240, UP
	end_exits
CavemanWater4ExitTable: ; 8d88e (23:588e)
	...
	exit 0, 26, 0, 27, 0, WATER, 3, 240, 216, LEFT
	exit 11, 31, 12, 31, 0, WATER, 2, 96, 8, DOWN
	exit 16, 0, 17, 0, 0, WATER, 5, 136, 240, UP
	exit 2, 0, 3, 0, 0, WATER, 9, 200, 240, UP
	end_exits
CavemanWater5ExitTable: ; 8d8df (23:58df)
	...
	exit 16, 31, 17, 31, 0, WATER, 4, 136, 8, DOWN
	exit 7, 31, 8, 31, 0, WATER, 9, 136, 40, DOWN
	end_exits
CavemanWater6ExitTable: ; 8d908 (23:5908)
	db 1
	dw CavemanWater6Exit_0
	begin_exits "CavemanWater6"
	exit 3, 12, 3, 12, 2, WATER, 3, 216, 96, DOWN
	end_exits
...
CavemanWater10ExitTable: ; 8d914 (23:5914)
	...
	exit 22, 31, 23, 31, 0, WATER, 3, 184, 8, DOWN
	exit 31, 5, 31, 6, 0, WATER, 9, 8, 48, RIGHT
	exit 4, 31, 5, 31, 0, WATER, 9, 72, 40, DOWN
	end_exits
CavemanWater8ExitTable: ; 8d951 (23:5951)
	...
	exit 0, 5, 0, 6, 0, WATER, 11, 240, 48, LEFT
	exit 8, 4, 9, 4, 0, WATER, 11, 40, 240, UP
	exit 16, 4, 17, 4, 0, WATER, 5, 64, 240, UP
	exit 23, 4, 24, 4, 0, WATER, 1, 112, 240, UP
	exit 8, 31, 9, 31, 0, WATER, 2, 224, 8, DOWN
	exit 16, 31, 17, 31, 0, WATER, 10, 136, 8, DOWN
	exit 24, 31, 25, 31, 0, WATER, 4, 24, 8, DOWN
	end_exits
CavemanWater9ExitTable: ; 8d9de (23:59de)
	db 2
	dw CavemanWater9Exit_0
	begin_exits "CavemanWater9"
	exit 16, 0, 17, 0, 0, WATER, 9, 136, 240, UP
	end_exits
...
IncaHub0ExitTable: ; 8d9f4 (23:59f4)
	...
	exit 31, 20, 31, 21, 0, LETTER, 0, 8, 224, RIGHT
	exit 0, 20, 0, 21, 0, MAYOR, 0, 240, 200, LEFT
	exit 15, 0, 16, 0, 0, JEWEL, 1, 128, 240, UP
	exit 15, 23, 16, 23, 4, BOSS, 0, 64, 104, UP
	exit 15, 11, 16, 11, 1, 3, 128, 96
	end_exits
IncaLetter0ExitTable: ; 8da55 (23:5a55)
	...
	exit 0, 27, 0, 28, 0, HUB, 0, 240, 168, LEFT
	exit 21, 0, 22, 0, 0, LETTER, 1, 72, 240, UP
	exit 31, 25, 31, 26, 0, LETTER, 2, 8, 224, RIGHT
	end_exits
IncaLetter1ExitTable: ; 8da92 (23:5a92)
	...
	exit 8, 31, 9, 31, 0, LETTER, 0, 176, 8, DOWN
	exit 20, 0, 21, 0, 0, LETTER, 3, 72, 240, UP
	exit 0, 20, 0, 21, 0, LETTER, 8, 240, 112, LEFT
	exit 7, 0, 8, 0, 0, LETTER, 12, 56, 240, UP
	end_exits
IncaLetter2ExitTable: ; 8dae3 (23:5ae3)
	db 2
	dw IncaLetter2Exit_0
	begin_exits "IncaLetter2"
	exit 0, 27, 0, 28, 0, LETTER, 0, 240, 208, LEFT
	end_exits
IncaLetter3ExitTable: ; 8daf8 (23:5af8)
	...
	exit 8, 31, 9, 31, 0, LETTER, 1, 168, 8, DOWN
	exit 31, 6, 31, 7, 0, LETTER, 4, 8, 216, RIGHT
	exit 29, 18, 29, 18, 2, LETTER, 6, 96, 40, DOWN
	end_exits
IncaLetter4ExitTable: ; 8db2b (23:5b2b)
	...
	exit 0, 26, 0, 27, 0, LETTER, 3, 240, 56, LEFT
	exit 25, 0, 26, 0, 0, LETTER, 5, 40, 240, UP
	end_exits
IncaLetter5ExitTable: ; 8db54 (23:5b54)
	...
	exit 4, 31, 5, 31, 0, LETTER, 4, 208, 8, DOWN
	exit 27, 11, 27, 11, 3, LETTER, 7, 128, 208, UP
	end_exits
IncaLetter6ExitTable: ; 8db73 (23:5b73)
	db 1
	dw IncaLetter6Exit_0
	begin_exits "IncaLetter6"
	exit 2, 11, 2, 11, 2, LETTER, 3, 232, 152, DOWN
	end_exits
...
IncaLetter8ExitTable: ; 8db7f (23:5b7f)
	...
	exit 28, 0, 29, 0, 0, LETTER, 9, 128, 232, UP
	exit 10, 30, 11, 30, 0, LETTER, 10, 168, 8, DOWN
	exit 0, 13, 0, 14, 0, LETTER, 11, 240, 112, LEFT
	exit 31, 13, 31, 14, 0, LETTER, 1, 8, 168, RIGHT
	end_exits
IncaLetter9ExitTable: ; 8dbd0 (23:5bd0)
	db 2
	dw IncaLetter9Exit_0
	begin_exits "IncaLetter9"
	exit 15, 30, 16, 30, 0, LETTER, 8, 232, 8, DOWN
	end_exits
IncaLetter10ExitTable: ; 8dbe5 (23:5be5)
	...
	exit 20, 0, 21, 0, 0, LETTER, 8, 88, 232, UP
	exit 0, 2, 0, 3, 0, LETTER, 11, 240, 224, LEFT
	end_exits
IncaLetter11ExitTable: ; 8dc0e (23:5c0e)
	...
	exit 31, 27, 31, 28, 0, LETTER, 10, 8, 24, RIGHT
	exit 31, 13, 31, 14, 0, LETTER, 8, 8, 112, RIGHT
	end_exits
IncaLetter12ExitTable: ; 8dc37 (23:5c37)
	...
	exit 6, 31, 7, 31, 0, LETTER, 1, 64, 8, DOWN
	exit 15, 0, 16, 0, 0, LETTER, 13, 128, 240, UP
	end_exits
IncaLetter13ExitTable: ; 8dc60 (23:5c60)
	db 2
	dw IncaLetter13Exit_0
	begin_exits "IncaLetter13"
	exit 15, 31, 16, 31, 0, LETTER, 12, 128, 8, DOWN
	end_exits
IncaMayor0ExitTable: ; 8dc75 (23:5c75)
	...
	exit 31, 24, 31, 25, 0, HUB, 0, 8, 168, RIGHT
	exit 24, 9, 25, 9, 0, MAYOR, 2, 200, 240, UP
	exit 16, 10, 16, 10, 2, MAYOR, 6, 24, 48, DOWN
	exit 11, 9, 12, 9, 0, MAYOR, 10, 128, 240, UP
	end_exits
IncaMayor1ExitTable: ; 8dcbc (23:5cbc)
	...
	exit 31, 23, 31, 24, 0, MAYOR, 2, 8, 160, RIGHT
	exit 0, 27, 0, 28, 0, MAYOR, 3, 240, 224, LEFT
	exit 6, 16, 6, 16, 3, MAYOR, 7, 120, 208, RIGHT
	end_exits
IncaMayor2ExitTable: ; 8dcef (23:5cef)
	...
	exit 24, 31, 25, 31, 0, MAYOR, 0, 200, 80, DOWN
	exit 0, 19, 0, 20, 0, MAYOR, 1, 240, 192, LEFT
	exit 31, 5, 31, 6, 0, MAYOR, 3, 8, 56, RIGHT
	exit 17, 0, 18, 0, 0, MAYOR, 4, 128, 240, UP
	exit 7, 31, 8, 31, 0, MAYOR, 10, 128, 40, DOWN
	end_exits
IncaMayor3ExitTable: ; 8dd54 (23:5d54)
	...
	exit 0, 6, 0, 7, 0, MAYOR, 2, 240, 48, DOWN
	exit 31, 27, 31, 28, 0, MAYOR, 1, 8, 224, RIGHT
	exit 18, 0, 19, 0, 0, MAYOR, 8, 152, 240, UP
	end_exits
IncaMayor4ExitTable: ; 8dd91 (23:5d91)
	...
	exit 15, 31, 16, 31, 0, MAYOR, 2, 144, 8, DOWN
	exit 15, 0, 16, 0, 0, MAYOR, 5, 128, 240, UP
	end_exits
IncaMayor5ExitTable: ; 8ddba (23:5dba)
	db 2
	dw IncaMayor5Exit_0
	begin_exits "IncaMayor5"
	exit 15, 31, 16, 31, 0, MAYOR, 4, 128, 8, DOWN
	end_exits
IncaMayor6ExitTable: ; 8ddcf (23:5dcf)
	db 1
	dw IncaMayor6Exit_0
	begin_exits "IncaMayor6"
	exit 7, 12, 7, 12, 2, MAYOR, 0, 128, 88, DOWN
	end_exits
...
IncaMayor8ExitTable: ; 8dddb (23:5ddb)
	...
	exit 18, 31, 19, 31, 0, MAYOR, 3, 152, 8, DOWN
	exit 28, 0, 29, 0, 0, MAYOR, 9, 152, 240, UP
	end_exits
IncaMayor9ExitTable: ; 8de04 (23:5e04)
	db 2
	dw IncaMayor9Exit_0
	begin_exits "IncaMayor9"
	exit 18, 31, 19, 31, 0, MAYOR, 8, 232, 8, DOWN
	end_exits
IncaMayor10ExitTable: ; 8de19 (23:5e19)
	...
	exit 15, 31, 16, 31, 0, MAYOR, 0, 96, 80, DOWN
	exit 15, 4, 16, 4, 0, MAYOR, 2, 64, 240, UP
	exit 26, 4, 27, 4, 0, MAYOR, 10, 208, 240, UP
	exit 4, 4, 5, 4, 0, MAYOR, 10, 48, 240, UP
	exit 25, 31, 26, 31, 0, MAYOR, 10, 216, 40, DOWN
	exit 5, 31, 6, 31, 0, MAYOR, 10, 40, 40, DOWN
	end_exits
IncaJewel0ExitTable: ; 8de92 (23:5e92)
	...
	exit 15, 31, 16, 31, 0, JEWEL, 4, 128, 8, DOWN
	exit 15, 0, 16, 0, 0, JEWEL, 5, 136, 240, UP
	exit 0, 20, 0, 21, 0, JEWEL, 0, 240, 168, LEFT
	exit 31, 20, 31, 20, 0, JEWEL, 0, 8, 168, RIGHT
	exit 31, 21, 31, 21, 0, JEWEL, 0, 8, 168, UP
	exit 26, 5, 26, 5, 2, JEWEL, 6, 24, 32, UP
	end_exits
IncaJewel1ExitTable: ; 8deed (23:5eed)
	...
	exit 15, 31, 16, 31, 0, HUB, 0, 128, 8, DOWN
	exit 0, 22, 0, 23, 0, JEWEL, 2, 240, 200, LEFT
	exit 4, 0, 5, 0, 0, JEWEL, 4, 40, 240, UP
	exit 10, 26, 10, 26, 3, JEWEL, 7, 128, 208, UP
	end_exits
IncaJewel2ExitTable: ; 8df34 (23:5f34)
	...
	exit 31, 24, 31, 25, 0, JEWEL, 1, 8, 184, RIGHT
	exit 5, 0, 6, 0, 0, JEWEL, 3, 48, 240, UP
	exit 17, 0, 18, 0, 0, JEWEL, 3, 144, 240, UP
	end_exits
IncaJewel3ExitTable: ; 8df71 (23:5f71)
	...
	exit 5, 31, 6, 31, 0, JEWEL, 2, 48, 8, DOWN
	exit 17, 31, 18, 31, 0, JEWEL, 2, 144, 8, DOWN
	exit 31, 8, 31, 9, 0, JEWEL, 4, 8, 72, RIGHT
	exit 26, 5, 26, 5, 2, JEWEL, 6, 24, 32, DOWN
	exit 15, 0, 16, 0, 0, JEWEL, 8, 128, 240, UP
	end_exits
IncaJewel4ExitTable: ; 8dfcc (23:5fcc)
	...
	exit 0, 8, 0, 9, 0, JEWEL, 3, 240, 72, LEFT
	exit 15, 0, 16, 0, 0, JEWEL, 0, 128, 240, UP
	exit 4, 31, 5, 31, 0, JEWEL, 1, 40, 8, DOWN
	end_exits
IncaJewel5ExitTable: ; 8e009 (23:6009)
	db 2
	dw IncaJewel5Exit_0
	begin_exits "IncaJewel5"
	exit 16, 31, 17, 31, 0, JEWEL, 0, 128, 8, DOWN
	end_exits
IncaJewel6ExitTable: ; 8e01e (23:601e)
	db 1
	dw IncaJewel6Exit_0
	begin_exits "IncaJewel6"
	exit 13, 9, 13, 9, 2, JEWEL, 3, 208, 48, DOWN
	end_exits
...
IncaJewel8ExitTable: ; 8e02a (23:602a)
	...
	exit 15, 31, 16, 31, 0, JEWEL, 3, 128, 8, DOWN
	exit 10, 0, 11, 0, 0, JEWEL, 9, 88, 240, UP
	end_exits
IncaJewel9ExitTable: ; 8e053 (23:6053)
	db 2
	dw IncaJewel9Exit_0
	begin_exits "IncaJewel9"
	exit 10, 31, 11, 31, 0, JEWEL, 8, 88, 8, DOWN
	end_exits
